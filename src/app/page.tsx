...
export default function Home() {
  ...
  return (
    <div>
      {/* Toast Notification */}
      <div
        className={`fixed top-6 left-1/2 z-[100] -translate-x-1/2 bg-green-600 text-white px-6 py-3 rounded-full shadow-lg text-base font-medium transition-opacity duration-700 ${
          showToast
